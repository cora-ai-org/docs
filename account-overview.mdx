...
| `status` | `string` | Granular account status |
| `status_category` | `string` | Broader account status category derived from `status` |
| `clientStatus` | `string \| null` | Freely input your own status |
