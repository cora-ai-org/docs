...
- [`payment.success`](/webhooks-payment-success) — normalized CRM-style fields plus optional tokenized fields (`gateway`, `tokenization`, `paymentPlan`, etc.); see that page for the full matrix.
